...
export function GlassmorphicCard({ children, className = '', onClick, backgroundColor = 'bg-gradient-to-br from-[#4682eb] via-[#2196f3] to-[#01beff]' }) {
  return (
    <div className={`relative w-[400px] h-[300px] m-8 transition-transform duration-250 [perspective:500px] group ${className}`} onClick={onClick}>
